...
public class DL_Service_Change_of_Biometrics_in_DL extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public DL_Service_Change_of_Biometrics_in_DL(WebDriver driver) {
	...
	public void SelcectService(int ServiceCode) {
		...
		case 526:
			...
			System.out.println("***********Welcome to ChangeofBioMetrics in_DL_Service************");
		...
		case 514:
			...
			break;
		case 513:
			System.out.println("***********Welcome to IssueofduplicateDL_in_DL_Service************");
