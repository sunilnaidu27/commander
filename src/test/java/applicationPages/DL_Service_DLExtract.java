...
public class DL_Service_DLExtract extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public DL_Service_DLExtract(WebDriver driver) {
	...
	@FindBy(how = How.XPATH, using = "//a[text()='DL EXTRACT REPORT']")
	WebElement DL_ExtactReport;

	public void Clickon_DL_ExtactReport() {

		stepstatus = basepage.clickElement(DL_ExtactReport);
		reportEvent(stepstatus, "Able to click On DL_ExtactReport", "UnAble to click On DL_ExtactReport", driver);
	}
	
	@FindBy(how = How.XPATH, using = "//input[@value='2']")
	WebElement Direct;

	public void Clickon_Direct() {

		stepstatus = basepage.clickElement(Direct);
		reportEvent(stepstatus, "Able to click On Direct", "UnAble to click On Direct", driver);
	}
	...
	public void Enter_DrivingLicNo() {

		stepstatus = basepage.setText(DrivingLicNo, getdata("DL"));
		reportEvent(stepstatus, "Able to Enter DL No", "UnAble to Enter DL No", driver);
	}
	
	@FindBy(how = How.XPATH, using = "//input[@value='Submit']")
	WebElement Submitin_DLExtact;

	public void Clickon_Submitin_DLExtact() {

		stepstatus = basepage.clickElement(Submitin_DLExtact);
		reportEvent(stepstatus, "Able to click On Submitin_DLExtact", "UnAble to click On Submitin_DLExtact", driver);
	}
	...
	@FindBy(how = How.XPATH, using = "//input[@id='approve']")
	WebElement Approve_DLExtact;

	public void Clickon_Approve_DLExtact() {

		stepstatus = basepage.clickElement(Approve_DLExtact);
		reportEvent(stepstatus, "Able to click On Approve_DLExtact", "UnAble to click On Approve_DLExtact", driver);
	}
