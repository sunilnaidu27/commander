...
public class DL_Service_Endorsement_to_drive_in_Hill_region extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public DL_Service_Endorsement_to_drive_in_Hill_region(WebDriver driver) {
	...
	public void SelcectService(int ServiceCode) {
		...
		case 524:
			...
			reportEvent(stepstatus, "Able to click on ENDORSEMENTTODRIVEINHILLREGION", "Unable to click on ENDORSEMENTTODRIVEINHILLREGION", driver, true);
	...
	@FindBy(how = How.XPATH, using = "//input[@name='method:proceedBookslotDTApp']")
