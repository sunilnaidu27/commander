...
public class DL_Service_IssueofDuplicateDL extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public DL_Service_IssueofDuplicateDL(WebDriver driver) {
	...
	WebElement ProceedforIssueofDuplicateDL;
	...
	public void Clickon_Proceed_Button() {
		stepstatus = basepage.clickElement(ProceedforIssueofDuplicateDL);
