...
public class DL_Service_RenewalofDL extends BasePage {

	BasePage basepage = new BasePage();
	WebDriver driver;
	boolean stepstatus;

	public DL_Service_RenewalofDL(WebDriver driver) {
	...
	@FindBy(how = How.XPATH, using = "//span[1][text()='Apply Online']")
	WebElement ApplyonlineforRenualService;
	@FindBy(how = How.XPATH, using = "//a[text()='Application Status']")
	WebElement ApplicationstatusforRenualService;
	@FindBy(how = How.XPATH, using = "//input[@id='applNum']")
	WebElement Application_NumberforRenualService;
	@FindBy(how = How.XPATH, using = "//input[@name='dateOfBirth']")
	WebElement DateofBirthforRenualService;
	@FindBy(how = How.XPATH, using = "//input[@id='submit']")
	WebElement SubmitforRenualService;
	...
	WebElement NextforRenualService;
	...
	public void Clickon_Applyonline() {
		stepstatus = basepage.clickElement(ApplyonlineforRenualService);
	...
	public void Clickon_Application_Status_Link() {
		stepstatus = basepage.clickElement(ApplicationstatusforRenualService);
	...
	public void Set_Application_Number(String value) {
		stepstatus = basepage.setText(Application_NumberforRenualService, value);
	...
	public void Set_DateofBirth(String value) {
		stepstatus = basepage.setText(DateofBirthforRenualService, value);
	...
	public void Clickon_Submit_Button() {
		stepstatus = basepage.clickElement(SubmitforRenualService);
	...
	public void Clickon_Next() {
		stepstatus = basepage.clickElement(NextforRenualService);
